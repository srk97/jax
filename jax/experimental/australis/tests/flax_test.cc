...
TEST(Flax, OptimizerStep) {
  ...
  EXPECT_EQ(
      "((Buffer(s32[]), (((((Buffer(f32[16]), Buffer(f32[16])), "
      "(Buffer(f32[4,16]), Buffer(f32[4,16]))), ((Buffer(f32[16]), "
      "Buffer(f32[16])), (Buffer(f32[16,16]), Buffer(f32[16,16]))), "
      "((Buffer(f32[16]), Buffer(f32[16])), (Buffer(f32[16,16]), "
      "Buffer(f32[16,16]))))))), ((((Buffer(f32[16]), Buffer(f32[4,16])), "
      "(Buffer(f32[16]), Buffer(f32[16,16])), (Buffer(f32[16]), "
      "Buffer(f32[16,16]))))))",
